...
echo "  /marketing <url>       Flusso autonomo: as-is, opportunita, proposta, piano e report visivo"
echo ""
...
echo "  /marketing report      Report visivo con grafici da consegnare al cliente"
echo ""
